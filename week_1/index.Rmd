...
# install.packages("renderthis")
 #library("renderthis")
#renderthis::to_pdf("file:///C:\\Users\\allison\\Documents\\classes\\134\\edmonds-cs-134-main\\week_1\\index.html")
```
...
<!-- add any other information about you -->


<!-- -- -->

<!-- .center[ -->
<!-- .box-1.medium[Instructor: Josh Goldberg] -->
<!-- ] -->

<!-- -- -->

<!-- .center[ -->
<!-- .box-1.medium[Data Scientist at Amazon] -->
<!-- ] -->

<!-- -- -->

<!-- .center[ -->
<!-- .box-1.medium[Master's in Data Science] -->
<!-- ] -->

<!-- -- -->

<!-- .center[ -->
<!-- .box-1.medium[Contact me at: josh.goldberg@edmonds.edu] -->
<!-- ] -->
...
<!-- 
.box-1.large[Recognize and create beautiful and truthful visualizations with real world data]
-->
...
- .left[**Reading material**]
  ...
  - .left[[R for Data Science](https://r4ds.had.co.nz/index.html) by Hadley Wickham and Garrett Grolemund]
...
- .left[**Technology**]
  ...
  - .left[The Esquisse library for R]
