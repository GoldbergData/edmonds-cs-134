---
title: '**CS 134, Winter 2023 | Exercise 1 | Introduction to R and the tidyverse**'
subtitle: Due Monday, January 23, 2023, 11:59 PM, *thanks to Andrew Weiss of Georgia
  State University for parts of this exercise*
output:
  html_document:
    df_print: paged
...
Complete these (the below bullets are links):
...
knitr::include_graphics(here::here("lessons", "img", "working-directory.png"), error = FALSE)
```
...
1. Watch this video:
    ...
    - https://player.vimeo.com/video/178485416?color=428bca

2. Skim through the content at these pages (links below):
